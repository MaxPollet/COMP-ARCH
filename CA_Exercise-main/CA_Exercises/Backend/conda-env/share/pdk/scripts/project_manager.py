...
try:
    ...
    pdk_root = '/users/students/r0757781/Documents/COMP-ARCH/CA_Exercise-main/CA_Exercises/Backend/conda-env/share/pdk'
...
class ProjectManager(ttk.Frame):
    ...
    def get_import_pdk(cls, projectpath):
        ...
        if os.getenv('PDK_ROOT'):
            ...
            PDK_ROOT = '/users/students/r0757781/Documents/COMP-ARCH/CA_Exercise-main/CA_Exercises/Backend/conda-env/share/share/pdk/'
