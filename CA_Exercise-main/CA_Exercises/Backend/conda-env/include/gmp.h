...
#define __GMP_CFLAGS "-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /users/students/r0757781/Documents/COMP-ARCH/CA_Exercise-main/CA_Exercises/Backend/conda-env/include -fdebug-prefix-map=/opt/conda/conda-bld/gmp_1653996257004/work=/usr/local/src/conda/gmp-6.2.1 -fdebug-prefix-map=/users/students/r0757781/Documents/COMP-ARCH/CA_Exercise-main/CA_Exercises/Backend/conda-env=/usr/local/src/conda-prefix"
