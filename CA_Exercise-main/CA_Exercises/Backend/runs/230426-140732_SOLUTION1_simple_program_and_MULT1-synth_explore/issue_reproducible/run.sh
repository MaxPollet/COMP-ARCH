...
export PACKAGED_SCRIPT_0='users/students/r0757781/Documents/COMP-ARCH/CA_Exercise-main/CA_Exercises/Backend/conda-env/share/openlane/scripts/yosys/synth.tcl';
...
export VERILOG_FILES='../Verilog/RTL_SOLUTION1_simple_program_and_MULT1/*.v';
